...
export const animals: Animal[] = [
  ...
  { name: 'Hippo', emoji: '🦛', soundUrl: 'https://upload.wikimedia.org/wikipedia/commons/f/f2/Hippo_vocalizations.ogg', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Hippo_vocalizations.ogg', difficulty: 'hard' },
