...
export const animals: Animal[] = [
  ...
  { name: 'Dog', emoji: '🐶', soundUrl: 'https://upload.wikimedia.org/wikipedia/commons/2/26/Dog_bark_1.ogg', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Dog_bark_1.ogg', difficulty: 'easy' },
  ...
  { name: 'Horse', emoji: '🐴', soundUrl: 'https://upload.wikimedia.org/wikipedia/commons/d/d3/Horse_whinny_approaching.ogg', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Horse_whinny_approaching.ogg', difficulty: 'easy' },
  ...
  // Medium animals
  { name: 'Lion', emoji: '🦁', soundUrl: 'https://upload.wikimedia.org/wikipedia/commons/6/62/Lion_raring-sound1TamilNadu178.ogg', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Lion_raring-sound1TamilNadu178.ogg', difficulty: 'medium' },
  ...
  { name: 'Elephant', emoji: '🐘', soundUrl: 'https://upload.wikimedia.org/wikipedia/commons/0/03/Elephant_voice_-_trumpeting.ogg', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Elephant_voice_-_trumpeting.ogg', difficulty: 'medium' },
  ...
  { name: 'Whale', emoji: '🐋', soundUrl: 'https://upload.wikimedia.org/wikipedia/commons/1/1b/Humpbackwhale2.ogg', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Humpbackwhale2.ogg', difficulty: 'medium' },
  ...
  { name: 'Bear', emoji: '🐻', soundUrl: 'https://upload.wikimedia.org/wikipedia/commons/5/52/Bear_growl.ogg', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Bear_growl.ogg', difficulty: 'medium' },
  { name: 'Eagle', emoji: '🦅', soundUrl: 'https://upload.wikimedia.org/wikipedia/commons/7/77/Haliaeetus_leucocephalus_-_Bald_Eagle_-_XC628424.ogg', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Haliaeetus_leucocephalus_-_Bald_Eagle_-_XC628424.ogg', difficulty: 'medium' },
  ...
  { name: 'Crow', emoji: '🐦‍⬛', soundUrl: 'https://upload.wikimedia.org/wikipedia/commons/c/c5/Crow_caw.ogg', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Crow_caw.ogg', difficulty: 'medium' },
  ...
  { name: 'Hippo', emoji: '🦛', soundUrl: 'https://upload.wikimedia.org/wikipedia/commons/2/23/Hippopotamus_amphibius_-_Hippopotamus_-_XC432353.ogg', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Hippopotamus_amphibius_-_Hippopotamus_-_XC432353.ogg', difficulty: 'hard' },
